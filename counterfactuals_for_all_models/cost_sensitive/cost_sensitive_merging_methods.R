...
load("counterfactuals_for_all_models/cost_sensitive/CEs/moc_cfactuals_xgb.rda")
...
load("counterfactuals_for_all_models/cost_sensitive/CEs/nice_cfactuals_xgb.rda")
...
load("counterfactuals_for_all_models/cost_sensitive/CEs/all_cfactuals_xgb.rda")
...
all_cfactuals_xgb$CE_Method <- rep("WhatIf", nrow(all_cfactuals_xgb))
all_cfactuals_xgb$Used_Model <- rep("XGBoost", nrow(all_cfactuals_xgb))

whatif_results <- rbind(all_cfactuals_ext, all_cfactuals_dt, all_cfactuals_rf, all_cfactuals_xgb,fill = TRUE)
...
moc_cfactuals_xgb$CE_Method <- rep("MOC", nrow(moc_cfactuals_xgb))
moc_cfactuals_xgb$Used_Model <- rep("XGBoost", nrow(moc_cfactuals_xgb))

moc_results <- rbind(moc_cfactuals_ext, moc_cfactuals_dt, moc_cfactuals_rf, moc_cfactuals_xgb,fill = TRUE)
...
nice_cfactuals_xgb$CE_Method <- rep("NICE", nrow(nice_cfactuals_xgb))
nice_cfactuals_xgb$Used_Model <- rep("XGBoost", nrow(nice_cfactuals_xgb))

nice_results <- rbind(nice_cfactuals_ext, nice_cfactuals_dt, nice_cfactuals_rf, nice_cfactuals_xgb,fill = TRUE)
