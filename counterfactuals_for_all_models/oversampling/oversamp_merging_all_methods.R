...
over_all_cfactuals_xgb$CE_Method <- rep("WhatIf", nrow(over_all_cfactuals_xgb))
over_all_cfactuals_xgb$Used_Model <- rep("XGBoost", nrow(over_all_cfactuals_xgb))

oversamp_whatif_results <- rbind(over_all_cfactuals_ext, over_all_cfactuals_dt, over_all_cfactuals_rf, over_all_cfactuals_xgb, fill = TRUE)
...
over_moc_cfactuals_xgb$CE_Method <- rep("MOC", nrow(over_moc_cfactuals_xgb))
over_moc_cfactuals_xgb$Used_Model <- rep("XGBoost", nrow(over_moc_cfactuals_xgb))

oversamp_moc_results <- rbind(over_moc_cfactuals_ext, over_moc_cfactuals_dt, over_moc_cfactuals_rf, over_moc_cfactuals_xgb, fill = TRUE)
...
over_nice_cfactuals_xgb$CE_Method <- rep("NICE", nrow(over_nice_cfactuals_xgb))
over_nice_cfactuals_xgb$Used_Model <- rep("XGBoost", nrow(over_nice_cfactuals_xgb))

oversamp_nice_results <- rbind(over_nice_cfactuals_ext, over_nice_cfactuals_dt, over_nice_cfactuals_rf, over_nice_cfactuals_xgb, fill = TRUE)
