...
under_nice_cfactuals_xgb <- rbindlist(under_nice_ce_xgb, fill = TRUE)
save(under_nice_cfactuals_xgb, file = "counterfactuals_for_all_models/undersampling/CEs/under_nice_cfactuals_xgb.rda")
